...
namespace MLZ_Sefer_Xheladini.Controllers
{
    public class RentsController : Controller
    {
        ...
        public RentsController(MLZ_Sefer_XheladiniContext context)
        {
            _context = context;
        }
        ...
        {
            var mLZ_Sefer_XheladiniContext = _context.Rent.Include(r => r.User);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RentId,BuildingTypeId,UserId,From,To,PricePerDaya,GuestWasHere")] Rent rent)
        {
            if (id != rent.RentId)
            {
                return NotFound();
