...
namespace MLZ_Sefer_Xheladini.Controllers
{
    public class ImagesController : Controller
    {
        ...
        public ImagesController(MLZ_Sefer_XheladiniContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ImageId,Name,Description,Content,ContentType")] Image image)
        {
            if (id != image.ImageId)
            {
                return NotFound();
